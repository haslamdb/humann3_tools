#!/usr/bin/env python3
"""
Test script to verify imports for key modules in humann3_tools package.

This script attempts to import key modules in the humann3_tools package
...
def main():
    ...
    print(f"{BOLD}Testing key imports for humann3_tools package{RESET}")
    ...
    key_modules = [
        # Core modules
        "src.humann3_tools.logger",
        
        # Utils modules
        "src.humann3_tools.utils.file_utils",
        "src.humann3_tools.utils.cmd_utils",
        "src.humann3_tools.utils.sample_utils",
        "src.humann3_tools.utils.resource_utils",
        "src.humann3_tools.utils.input_handler",
        
        # HUMAnN3 modules
        "src.humann3_tools.humann3.gene_processing",
        "src.humann3_tools.humann3.pathway_processing",
        "src.humann3_tools.humann3.join_unstratify",
        
        # Analysis modules
        "src.humann3_tools.analysis.metadata",
        "src.humann3_tools.analysis.statistical",
        "src.humann3_tools.analysis.differential_abundance",
        "src.humann3_tools.analysis.visualizations",
        
        # CLI modules
        "src.humann3_tools.cli.main_cli",
