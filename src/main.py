...
def process_humann3_files_only(
    sample_key,
    pathway_dir,
    gene_dir,
    output_dir,
...
def analyze_existing_humann3_files(
    pathway_file,
    gene_file,
    sample_key,
    output_dir,
...
# Differential abundance analysis
        if not args.skip_downstream and args.run_diff_abundance:
            try:
                ...
                if pathway_unstrat_file and check_file_exists_with_logger(pathway_unstrat_file, "Pathways", logger):
                    ...
                    pathway_diff_results = run_pathway_differential_abundance(
                        pathway_unstrat_file, 
                        args.sample_key, 
                        args.output_dir,
                ...
                if gene_unstrat_file and check_file_exists_with_logger(gene_unstrat_file, "Gene families", logger):
                    ...
                    gene_diff_results = run_gene_differential_abundance(
                        gene_unstrat_file, 
                        args.sample_key, 
                        args.output_dir,
                        group_col=args.group_col, 
