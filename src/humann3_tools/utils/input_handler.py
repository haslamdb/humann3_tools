...
def get_input_files(args, input_type: str = "sequence") -> Dict[str, Dict]:
    ...
    Args:
        ...
        input_type: Type of input files ("sequence", "kneaddata", "humann3", etc.)
...
def find_humann3_output_files(samples: Dict[str, Dict], output_dir: str) -> Dict[str, Dict]:
    """
    ...
    Returns:
        Updated samples dictionary with 'humann3_files' key for each sample
    """
