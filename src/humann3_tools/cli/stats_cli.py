...
def main():
    ...
    logger.info(f"  humann3-tools diff --abundance-file {args.abundance_file} --metadata-file {args.metadata_file}")
    logger.info("\n  For visualizations:")
...
Examples:
  # Basic usage:
  humann3-tools stats --abundance-file joined_output/pathway_abundance_cpm_unstratified.tsv \
                    --metadata-file metadata.csv \
                    --output-dir ./statistical_results
  
  # Specify group column:
  humann3-tools stats --abundance-file joined_output/gene_families_cpm_unstratified.tsv \
                    --metadata-file metadata.csv \
                    --group-col Treatment \
                    --output-dir ./statistical_results
